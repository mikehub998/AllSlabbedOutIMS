...
public class OrderController implements CrudController<Order> {
    ...
    public Order create() {
        ...
        LOGGER.info("Please enter the product id number to add to the order:");
        Long productId = utils.getLong();
        LOGGER.info("Please enter the date order was placed:");
        String datePlaced = utils.getString();
        LOGGER.info("Order total:");
        Long orderTotal = utils.getLong();
        Order order = orderDAO.create(new Order(customerId, productId, datePlaced, orderTotal));
    ...
    public Order update() {
        ...
        Long customerId = utils.getLong();
        LOGGER.info("Please enter the product id number:");
        Long productId = utils.getLong();
        LOGGER.info("Please enter the date the order was placed:");
        String datePlaced = utils.getString();
//        possibly a string here
        Long orderTotal = utils.getLong();
        Order order = orderDAO.update(new Order(orderId, customerId, productId, datePlaced, orderTotal));
