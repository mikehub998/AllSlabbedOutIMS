...
INSERT INTO `all_slabbed_out_db`.`orders` (`order_id`, `date_placed`, `order_total`) VALUES ('1', '13.06.23', '19.24');
INSERT INTO `all_slabbed_out_db`.`orders_products` (`product_id`, `amount`, `orderprod_total`) VALUES ('1', '200', '2380.00');
